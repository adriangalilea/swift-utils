...
//
//   swift run brandgen add imdb spotify github   # fetch + regenerate
...
let catalog = root.appending(path: "Sources/Ink/Resources/Brands.xcassets")
let generated = root.appending(path: "Sources/Ink/Brands.generated.swift")
